...
public class BooleanProperty extends PropertyBinding<Boolean> {
	...
	public BooleanProperty(Object object, String propertyName, Bindings binding) {
	...
	public void setValue(Object value) {
		try {
			super.setValue(Boolean.parseBoolean(value.toString()));
		} catch (Exception ex) {
			Log.e(tag, ex);
		}
	}
	...
	public void setValueWithouthRaise(Object value) {
		try {
			super.setValueWithouthRaise(Boolean.parseBoolean(value.toString()));
		} catch (Exception ex) {
			Log.e(tag, ex);
		}
	}
