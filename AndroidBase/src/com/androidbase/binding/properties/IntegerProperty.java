...
public class IntegerProperty extends PropertyBinding<Integer> {

	// region Properties

	protected String tag = "IntegerProperty";

	// endregion

	// region Constructors

	public IntegerProperty(Object object, String propertyName, Bindings binding) {
	...
	public void setValueWithouthRaise(Object value) {
		try {
			super.setValueWithouthRaise(Integer.parseInt(value.toString()));
		} catch (Exception ex) {
			Log.e(tag, ex);
		}
	}
