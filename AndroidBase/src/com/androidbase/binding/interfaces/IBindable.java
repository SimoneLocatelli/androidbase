 ...
 */
package com.androidbase.binding.interfaces;

import com.androidbase.binding.enums.Bindings;
import com.androidbase.binding.properties.PropertyBinding;

public interface IBindable<T> extends IPropertyChangedListener<T> {

	public void onBindingChanged(Bindings binding);

	// public void onPropertyChanged(PropertyBinding<T> property);

	public void binding(PropertyBinding<T> property);
